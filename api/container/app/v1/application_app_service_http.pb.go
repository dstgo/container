...
const OperationAppCreateApp = "/container.api.container.app.v1.App/CreateApp"
const OperationAppDeleteApp = "/container.api.container.app.v1.App/DeleteApp"
const OperationAppGetApp = "/container.api.container.app.v1.App/GetApp"
const OperationAppListApp = "/container.api.container.app.v1.App/ListApp"
const OperationAppUpdateApp = "/container.api.container.app.v1.App/UpdateApp"
const OperationAppUpdateAppStatus = "/container.api.container.app.v1.App/UpdateAppStatus"
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	r := s.Route("/")
	r.GET("/container/client/v1/app", _App_GetApp0_HTTP_Handler(srv))
	r.GET("/container/api/v1/app", _App_GetApp1_HTTP_Handler(srv))
	r.GET("/container/api/v1/apps", _App_ListApp0_HTTP_Handler(srv))
	r.POST("/container/api/v1/app", _App_CreateApp0_HTTP_Handler(srv))
	r.PUT("/container/api/v1/app", _App_UpdateApp0_HTTP_Handler(srv))
	r.PUT("/container/api/v1/app/status", _App_UpdateAppStatus0_HTTP_Handler(srv))
	r.DELETE("/container/api/v1/app", _App_DeleteApp0_HTTP_Handler(srv))
}
...
func (c *AppHTTPClientImpl) UpdateAppStatus(ctx context.Context, in *UpdateAppStatusRequest, opts ...http.CallOption) (*UpdateAppStatusReply, error) {
	...
	pattern := "/container/api/v1/app/status"
	path := binding.EncodeURL(pattern, in, false)
