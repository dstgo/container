...
const OperationChannelCreateChannel = "/container.api.container.channel.v1.Channel/CreateChannel"
const OperationChannelDeleteChannel = "/container.api.container.channel.v1.Channel/DeleteChannel"
const OperationChannelListChannel = "/container.api.container.channel.v1.Channel/ListChannel"
const OperationChannelListChannelType = "/container.api.container.channel.v1.Channel/ListChannelType"
const OperationChannelUpdateChannel = "/container.api.container.channel.v1.Channel/UpdateChannel"
...
func RegisterChannelHTTPServer(s *http.Server, srv ChannelHTTPServer) {
	r := s.Route("/")
	r.GET("/container/api/v1/channel/types", _Channel_ListChannelType0_HTTP_Handler(srv))
	r.GET("/container/api/v1/channels", _Channel_ListChannel0_HTTP_Handler(srv))
	r.POST("/container/api/v1/channel", _Channel_CreateChannel0_HTTP_Handler(srv))
	r.PUT("/container/api/v1/channel", _Channel_UpdateChannel0_HTTP_Handler(srv))
	r.DELETE("/container/api/v1/channel", _Channel_DeleteChannel0_HTTP_Handler(srv))
}
...
func (c *ChannelHTTPClientImpl) CreateChannel(ctx context.Context, in *CreateChannelRequest, opts ...http.CallOption) (*CreateChannelReply, error) {
	...
	pattern := "/container/api/v1/channel"
...
func (c *ChannelHTTPClientImpl) ListChannel(ctx context.Context, in *ListChannelRequest, opts ...http.CallOption) (*ListChannelReply, error) {
	...
	pattern := "/container/api/v1/channels"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChannelHTTPClientImpl) ListChannelType(ctx context.Context, in *ListChannelTypeRequest, opts ...http.CallOption) (*ListChannelTypeReply, error) {
	...
	pattern := "/container/api/v1/channel/types"
	path := binding.EncodeURL(pattern, in, true)
