...
const OperationFieldCreateField = "/container.api.container.field.v1.Field/CreateField"
const OperationFieldDeleteField = "/container.api.container.field.v1.Field/DeleteField"
const OperationFieldListField = "/container.api.container.field.v1.Field/ListField"
const OperationFieldListFieldType = "/container.api.container.field.v1.Field/ListFieldType"
const OperationFieldUpdateField = "/container.api.container.field.v1.Field/UpdateField"
...
func RegisterFieldHTTPServer(s *http.Server, srv FieldHTTPServer) {
	r := s.Route("/")
	r.GET("/container/api/v1/field/types", _Field_ListFieldType0_HTTP_Handler(srv))
	r.GET("/container/api/v1/fields", _Field_ListField0_HTTP_Handler(srv))
	r.POST("/container/api/v1/field", _Field_CreateField0_HTTP_Handler(srv))
	r.PUT("/container/api/v1/field", _Field_UpdateField0_HTTP_Handler(srv))
	r.DELETE("/container/api/v1/field", _Field_DeleteField0_HTTP_Handler(srv))
}
...
func (c *FieldHTTPClientImpl) CreateField(ctx context.Context, in *CreateFieldRequest, opts ...http.CallOption) (*CreateFieldReply, error) {
	...
	pattern := "/container/api/v1/field"
...
func (c *FieldHTTPClientImpl) ListField(ctx context.Context, in *ListFieldRequest, opts ...http.CallOption) (*ListFieldReply, error) {
	...
	pattern := "/container/api/v1/fields"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *FieldHTTPClientImpl) ListFieldType(ctx context.Context, in *ListFieldTypeRequest, opts ...http.CallOption) (*ListFieldTypeReply, error) {
	...
	pattern := "/container/api/v1/field/types"
	path := binding.EncodeURL(pattern, in, true)
